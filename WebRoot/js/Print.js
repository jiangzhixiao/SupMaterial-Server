...
function PrintDeptGroup(map,printFlag){
	...
	for (i = 0; i < map.length; i++) {
		...
		LODOP.ADD_PRINT_TEXT(40,510,140,20,"单号："+billNo);
		LODOP.ADD_PRINT_TEXT(59,10,150,20,"仓　　库："+storageName);
		LODOP.ADD_PRINT_TEXT(59,300,71,20,"记 账 人：");
		LODOP.ADD_PRINT_TEXT(59,510,160,20,"页码："+ "第"+currentPage+"页 / 共"+totalPage+"页");
...
//		
		...
		LODOP.ADD_PRINT_TEXT(detailHeight,150,80,30,"收货人：");
		LODOP.ADD_PRINT_TEXT(detailHeight,250,80,30,"制单人：");
